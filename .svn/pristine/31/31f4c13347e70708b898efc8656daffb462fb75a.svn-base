...
public class LearningActivityCompletionValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
	   ...
	   ParameterPageUi c = (ParameterPageUi) target;
	   if(c.getFromDate() == null || c.getToDate() == null  || c.getFromDate().trim().length() == 0 || c.getToDate().trim().length()== 0){
		   return;
	   }
      ...
      String[] userFromDate = c.getFromDate().trim().split("/");
      ...
      try{
          ...
          String[] userToDate = c.getToDate().trim().split("/");
