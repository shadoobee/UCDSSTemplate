...
public class ComplianceByActivityReportRowMapper implements RowMapper<Learner> {
	...
	public Learner mapRow(ResultSet rs, int rowNum)
	    ...
	    c.setStrDueDate(rs.getString("DueDate"));
	    c.setStrCompletionDate(rs.getString("CompletionDate"));
	    c.setStrExpirationDate(rs.getString("ExpirationDate"));
		...
		c.setStrTraningDueDate(rs.getString("training_due_date"));
		c.setLearnerEmployeeNumber(rs.getString("emp_cntry"));
		return c;
	}
